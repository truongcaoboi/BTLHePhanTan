...
public class DataControl {
    ...
    public static boolean updateInfoAccount(String address, String email, String phone,String name, String stk) {
        Connection con = null;
        Statement state = null;
        boolean flag = true;
        try {
            System.out.println(address);
            String sql = "update account set address=\'" + address + "\',email=\'" + email + "\',phone=\'" + phone + "\',fullname=\'"+name+"\' where Account_No=\'" + stk + "\'";
            //System.out.println(sql);
            con = DataAccess.getConnect1();
            state = con.createStatement();
            state.execute(sql);
        ...
        UpdateDatabase2.updateInfoAccount(address, email, phone,name, stk);
        return flag;
    }
