...
//				String [] array=res.split(";");
	...
	public static String updateAccount(String address, String email, String phone,String name, String stk) {
		String res="";
		try {
			String request="4;{\"address\":\""+address+"\",\"email\":\""+email+"\",\"phone\":\""+phone+"\",\"stk\":\""+stk+"\",\"name\":\""+name+"\"}";
			Communication com=new Communication();
			com.SendRequest(request);
